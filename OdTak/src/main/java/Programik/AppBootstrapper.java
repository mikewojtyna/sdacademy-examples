...
public class AppBootstrapper {
	public static void start() throws Exception {new AppBootstrapper().szyfrowanie();}

	public void szyfrowanie() throws Exception {
		DodawanieUzytkownika dU = new DodawanieUzytkownika();
		Uzytkownik kasia = new Uzytkownik("", "");
		Uzytkownik tomek = new Uzytkownik("", "");
