...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Czy w liscie jest ala? : " + napisy.contains("ma"));

        List<String> napisy2 = new ArrayList<>();
        napisy2.add("ma");
        napisy2.add("kota");
        System.out.println("Czy wszystkie elementy napisy2 znajdują się w napisy? : "
                        + napisy.containsAll(napisy2));
